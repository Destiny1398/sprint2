...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO vehicles (vehicle_type, make, model, year, car_type, fuel_type, transmission, airbags, seats, doors, price, image_paths, admin_id)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";

    $stmt = $conn->prepare($sql);
    $stmt->bind_param("sssssssiiidsi", $vehicle_type, $make, $model, $year, $car_type, $fuel_type, $transmission, $airbags, $seats, $doors, $price, $image_paths, $admin_id);
